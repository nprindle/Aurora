...
export const CEVTech = Technology.makeUnlockableTechnology(
    ...
    "What humanity's wishes would be if they knew more, thought faster, were more the people they wished they were, had grown up farther together; where the extrapolation converges rather than diverges, where their wishes cohere rather than interfere; extrapolated as they wish that extrapolated, interpreted as they wish that interpreted.",
...
export const AcausalTradeTech = Technology.makeUnlockableTechnology(
    "Acausal trade",
    "An application of game theory that allows two agents to each benefit by predicting what the other wants and doing it, even though they might have no way of communicating or affecting each other, nor even any direct evidence that the other exists. This can also be applied to acausal threats and blackmail, such as in the \"Roko's Basilisk\" thought experiment.",
    [DecisionTheoryTech],
...
export const CooperativeReprogrammingTech = Technology.makeUnlockableTechnology(
    ...
    "A technique for exploiting an inconsistency in the Neuromorphic Heuristic Intelligence's mental architecture that allows its goals to be reprogrammed. This would make it possible for the Overseer to protect human values at the expense of completing its original mission.",
...
export const XenoarchaeologyTech = Technology.makeUnlockableTechnology(
    "Xenoarchaeology",
    "Archaeological exploration of the alien ruins could reveal information about the long-dead alien civilization as well as revealing valuable resources.",
    [SurveyTech],
...
export const AlienHistoryTech = Technology.makeUnlockableTechnology(
    "Alien History",
    "Deciphering the artifacts and writings found in the alien ruins can provide information about the history of their civilization. What is the purpose of the ruins and the towering monolith structure? Was their civilization consumed by war over competing philosophies? What might alien philosophy be like?",
...
export const HypercomputingTech = Technology.makeUnlockableTechnology(
    "Hypercomputing",
    "Powerful new models of computation that could eclipse traditional computer technology and produce results that are not turing-computable",
    [XenoMaterialsTech],
    new Cost(Resource.EngineeringKnowledge, 100)
);
...
export const NeuralUploadingTech = Technology.makeUnlockableTechnology(
    "Neural Uploading",
    "Exploration of the alien monolith revealed that its memory banks store copies of the alien lifeforms' connectomes, which could potentially be used to resurrect their minds within a virtual reality. Studying this technology could allow us to reactivate these minds, or even scan and simulate human minds with perfect fidelity.",
...
export const SingularityEngineeringTech = Technology.makeUnlockableTechnology(
    ...
    "The alien monolith appears to be the seed of a self-replicating computer network, which was designed to convert the entire planet, and perhaps the entire galaxy, into a maximally-efficient computing substrate. It may be possible to unlock all of the aliens' data by repairing and activating this machine.",
    [MonolithSurveyTech],
